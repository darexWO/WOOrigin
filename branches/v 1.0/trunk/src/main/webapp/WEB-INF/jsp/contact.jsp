...
<div class="content">
    ...
    <table style="float:left;width:716px;color:#58595b;margin-left:10px;font-size:12px;line-height:16px;">
        <tr>
            <td colspan="3" style="font-size:16px;color:#faa635;font-weight: 600;padding-top:25px;padding-bottom: 10px;">Prodaja</td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                e-mail: <b><a style="color:#58595b;" href="mailto:radmila.azanjac@darex.rs">radmila.azanjac@darex.rs</a></b>
            </td>
            <td>
        ...
        <tr>
            <td colspan="3" style="font-size:16px;color:#faa635;font-weight: 600;padding-top: 25px;padding-bottom: 10px;">Regionalni menadžeri</td>
        </tr>
        <tr>
            <td>
                <b>Bojan Periæ</b><br>
                ...
                e-mail: <b><a style="color:#58595b;" href="mailto:radisa.vatazovic@darex.rs">radisa.vatazovic@darex.rs</a></b>
            </td>
            <td>
                ...
                <b>Slaviša Petroviæ</b><br>
                mob: 065/31 95 244<br>
                e-mail: <b><a style="color:#58595b;" href="mailto:slavisa.petrovic@darex.rs">slavisa.petrovic@darex.rs</a></b>
            </td>
            <td>
                ...
                e-mail: <b><a style="color:#58595b;" href="mailto:vladimir.besevic@darex.rs">vladimir.besevic@darex.rs</a></b>
            </td>
        </tr>
        <tr>
            <td style="font-size:16px;color:#faa635;font-weight: 600;padding-top: 25px;padding-bottom: 10px;">Šef distributivnih centara</td>
            <td></td>
            <td style="font-size:16px;color:#faa635;font-weight: 600;padding-top: 25px;padding-bottom: 10px;">Direktor prodaje</td>
        </tr>
        <tr>
            <td>
                <b>Snežana Beševiæ</b><br>
                tel: 011/20 91 650<br>
                mob: 065/31 95 248<br>
                e-mail: <b><a style="color:#58595b;" href="mailto:snezana.besevic@darex.rs">snezana.besevic@darex.rs</a></b>
            </td>
            <td></td>
            <td>
                <b>Žarko Jekiæ</b><br>
                tel: 011/20 91 605<br>
                mob: 065/31 95 250<br>
                e-mail: <b><a style="color:#58595b;" href="mailto:zarko.jekic@darex.rs">zarko.jekic@darex.rs</a></b>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="font-size:16px;color:#faa635;font-weight: 600;padding-top: 25px;padding-bottom: 10px;">Distributivni Centri</td>
        </tr>
        <tr>
            <td>
                <b>Distributivni Centar Novi Beograd</b><br>
                Autoput Beograd - Zagreb bb<br>
                1077 Novi Beograd<br>
            ...
            <td>
                ...
                fax: 018/207 369<br>
                e-mail: <b><a style="color:#58595b;" href="mailto:distribucija@darex.rs">distribucija@darex.rs</a></b><br>
            </td>
            <td>
        ...
        <tr>
            <td colspan="3" style="text-align: center;padding-top: 50px;padding-bottom: 25px;">
                Sve primedbe i sugestije poslati na e-mail: <b><a style="color:#58595b;" href="mailto:primedbe.sugestije@darex.rs">primedbe.sugestije@darex.rs</a></b><br>
