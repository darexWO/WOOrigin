...
<c:when test="${oj == 30}">
    <table style="float:left;width:716px;color:#58595b;margin-left:10px;font-size:12px;line-height:16px;">
        ...
        <tr>
            <td colspan="3">
                <b>Miloš Ðuraševiæ</b><br>
                tel: +382 (0)20 225 289<br>
                mob: +382 (0)68 044 554<br>
                e-mail: <b><a style="color:#58595b;" href="mailto:milos.djurasevic@darexmax.me">milos.djurasevic@darexmax.me</a></b><br><br>
            </td>
        </tr>
        <tr>
            <td colspan="3"
        ...
        <tr>
            ...
            <td>
                <b>Žarko Jekiæ</b><br>
                tel: +382 (0)20 225 289<br>
                mob: +381 (0)65 31 95 250<br>
                e-mail: <b><a style="color:#58595b;" href="mailto:zarko.jekic@darex.me">zarko.jekic@darex.me</a></b>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                Bulevar Svetog Petra Cetinjskog 79<br>
                81000 Podgorica<br>
                tel: +382 (0)20 225 289<br>
            ...
            <td>
                Bukovica bb<br>
                32250 Ivanjica<br>
                tel: +381 (0)32 641 353<br>
                fax: +381 (0)32 642 222<br>
