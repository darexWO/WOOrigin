...
public class User {
    ...
    private Map<Integer, WoRezervacija> basket = new LinkedHashMap<Integer, WoRezervacija> ();
    ...
    public Map<Integer, WoRezervacija> getBasket() {
        return basket;
    }

    public void setBasket(Map<Integer, WoRezervacija> basket) {
        this.basket = basket;
    }
