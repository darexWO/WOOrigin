...
(function($) {
    ...
    $.fn.createProductItemDiv = function(item) {
        ...
        var product="<div class='product_item' style='display: none;'>" +
                    ...
                    "</div>" +
                    "<div class='kol_pak ellipsis'>Koli&#269;ina po pakovanju: " + item.kolicinaPoPakovanju + " " + item.jedinicaMere.skracenaOznaka.toLowerCase() + "</div>" +
					"<div class='kolicina'>Poruèiti: : <input type='text' id='orderedQuantity-" + item.proizvod + "' value=''/>" +  item.jedinicaMereAltRef.skracenaOznaka.toLowerCase() + "</div>" +
    ...
    $.fn.dialogCfgMSG = function() {
        $("#dialog-message,#dialog-message-w").dialog({
            width:"320px",
            height:"auto",
            autoOpen: false,
            show: "explode",
