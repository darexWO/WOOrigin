...
public class BasketController {
    ...
    public @ResponseBody String addToBasket(HttpSession session, String productId, String orderedQuantity) {
        log.info("proizvod=" + productId + " orderedQuantity="+orderedQuantity);
