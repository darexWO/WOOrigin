...
<div class="G1">
    <c:choose>
        <c:when test="${oj == 30}">><a href="http://www.darexmax.rs" target="_blank"><img src="images/logo/logo_dm.png" alt=""/></a></c:when>
        <c:when test="${oj == 40}">><a href="http://www.darexitison.rs" target="_blank"><img src="images/logo/logo_di.png" alt=""/></a></c:when>
        <c:otherwise><a href="http://www.darex.rs" target="_blank"><img src="images/logo/logo_d.png" alt=""/></a></c:otherwise>
    </c:choose>
    <div class="G3">
        <div class="G3_L light_gray_gradient">
            <ul>
                ...
                <li>
                    <a href='support' ${url == '/support' ? "class='selected'":""}>Podrška</a>
                </li>
                <li>
        ...
        <div class="G3_D">
            ...
            <input type="button" class="btn login" value="SingOut" onClick="location.href='logout'" style="margin-right:5px;" />
        </div>
    </div>
    <div class="G2">
        <ul>
        ...
        <c:if test="${loginUser.woUser.userType == 'INTERNI'}">
            ...
            <div class="ui-widgetT" style="float:right;line-height:37px;"><input type="text" value="PARTNER" id="partnerPretraga" style="width:240px;margin-right:5px;" onfocus="javascript: this.value = ''" onblur="javascript: if (this.value=='') this.value = 'KOMITENT'"/></div>
        </c:if>
    </div>
</div>
