...
public class CommonService {
    ...
    public List<OcpPoslovniPartner> findPartnerByName(String namePattern) {
        ...
        if (partners!=null)
            for(OcpPoslovniPartner partner:partners) System.out.println(partner.getNaziv());
        return partners;
    }
    ...
    public void sendEmailConfirmation(String reportUrl, WoParametri woParametri, User user, List<String> fakture) {
        try {
            ...
            System.out.println("user=" + user.getWoUser().getUserType() + "  email=" + user.getWoUser().getEmail());
