    ...
    <form action="login" method="POST">
        ...
        <table cellspacing=0 cellpadding=0 border=0 style="width:580px;margin:5px;">
            <tr>
                ...
                <td><img src="images/logo/logo_dm_s.png" alt=""/></td>
            ...
            <tr>
                ...
                <td><input type="radio" name="oj" value="30" ${param.oj == 20 ? "checked":""}></td>
				<td><input type="radio" name="oj" value="20" ${param.oj == 21 ? "checked":""}></td>
